...
//     mongodb+srv://<username>:<password>@cluster0.68b47b6f9300b944131b4d86.mongodb.net/<database>?retryWrites=true&w=majority
...
mongoose
  .connect("mongodb+srv://infomuaqib_db_user:infomuaqib_db_user@cluster0.7xldddc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
  // .connect("mongodb+srv://infomuaqib_db_user:infomuaqib_db_user@cluster0.hp2dlnp.mongodb.net/?retryWrites=true&w=majority")
  .then(() => {
    console.log("Connected to DB");
    app.listen(PORT, () => console.log("Server is running on port " + PORT));
  })
